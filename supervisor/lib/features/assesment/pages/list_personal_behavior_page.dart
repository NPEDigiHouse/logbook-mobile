...
import 'supervisor_personal_behavior_detail_page.dart';
...
class _ListPersonalBehaviorPageState extends State<ListPersonalBehaviorPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Personal Behavior Grade"),
      ).variant(),
          ...
          builder: (context, state) {
            if (state.personalBehaviorStudent != null &&
              ...
              return const EmptyData(
                title: 'No Data',
                subtitle:
                    'All personal behaviors data has been verified, please check history',
              );
            }
