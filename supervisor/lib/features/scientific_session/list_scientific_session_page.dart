...
class SupervisorListScientificSessionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: _SupervisorListScientificSessionView(),
    );
  }
}

class _SupervisorListScientificSessionView extends StatefulWidget {
  @override
  State<_SupervisorListScientificSessionView> createState() =>
      _SupervisorListScientificSessionViewState();
}

class _SupervisorListScientificSessionViewState
    extends State<_SupervisorListScientificSessionView> {
  late int page;
  String? query;
  ...
  void initState() {
    ...
    BlocProvider.of<ScientificSessionSupervisorCubit>(context)
        .getScientificSessionList(page: page);
  }

  void _onScroll() {
    final state =
        context.read<ScientificSessionSupervisorCubit>().state.fetchState;
        ...
        body: SafeArea(
          child: RefreshIndicator(
              ...
              child: BlocSelector<
                  ...
                  (List<ScientificSessionOnListModel>?, RequestState?)>(
                selector: (state) => (state.listData, state.fetchState),
