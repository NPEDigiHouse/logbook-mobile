...
class DetailClinicalRecordPage extends StatelessWidget {
  const DetailClinicalRecordPage({super.key});
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Simple preverbal visual acuity examination',
                            style: textTheme.bodyMedium?.copyWith(
                              color: secondaryTextColor,
                            ),
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Primary eye positon (Hisberg test/ Krimsky method)',
                            style: textTheme.bodyMedium?.copyWith(
                              color: secondaryTextColor,
                            ),
                          ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'clinical_record_attachment/P-0',
                            style: textTheme.bodyMedium?.copyWith(
                              color: secondaryTextColor,
                            ),
                            maxLines: 1,
