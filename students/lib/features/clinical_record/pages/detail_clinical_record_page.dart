...
class DetailClinicalRecordPage extends StatefulWidget {
  ...
  const DetailClinicalRecordPage(
      {super.key, required this.id, required this.department, this.onUpdate});
    ...
    return BlocListener<ClinicalRecordCubit, ClinicalRecordState>(
      listener: (context, state) {
        ...
        if (state.clinicalRecordPostSuccess) {
          CustomAlert.success(
              message: "Success update clinical record", context: context);
        }
      },
      child: Scaffold(
        appBar: AppBar(
                    ...
                    return SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          if (state.detailClinicalRecordModel?.examinations !=
                                  null &&
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...state
                                      .detailClinicalRecordModel!.examinations!
                                      .map((e) {
                                    return Column(
                                      crossAxisAlignment:
                          ...
                          if (state.detailClinicalRecordModel?.diagnosess !=
                                  null &&
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...state
                                      .detailClinicalRecordModel!.diagnosess!
                                      .map((e) {
                                    return Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                          ...
                          if (state.detailClinicalRecordModel?.managements !=
                                  null &&
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...state
                                      .detailClinicalRecordModel!.managements!
                                      .map((e) {
                                    return Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                          ...
                          if (state.detailClinicalRecordModel?.notes != null &&
                              state.detailClinicalRecordModel!.notes!
                                  .isNotEmpty) ...[
                            Container(
                              margin:
                                  const EdgeInsets.symmetric(horizontal: 24),
