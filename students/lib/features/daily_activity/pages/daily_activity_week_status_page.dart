...
class _DailyActivityWeekStatusPageState
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          floatingActionButton:
              (state.activityPerDays?.dayExist?.length ?? 0) < 7
                  ? FloatingActionButton(
            ...
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                slivers: [
                  ...
                  else if (state.activityPerDays != null)
                    SliverToBoxAdapter(
                      child: SpacingColumn(
  ...
  Container _cardOverview(BuildContext context, DailyActivityState state) {
    return Container(
