...
import '../pages/final_score/student_final_score_page.dart';

class FinalGradeCard extends StatefulWidget {
  final ActiveDepartmentModel model;
  const FinalGradeCard({super.key, required this.model});
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        width: 220,
                                        child: Text(
                                          'Your recap and final score for this department',
                                          maxLines: 2,
