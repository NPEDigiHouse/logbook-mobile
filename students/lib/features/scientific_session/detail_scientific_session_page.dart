...
class DetailScientificSessionPage extends StatefulWidget {
  ...
  const DetailScientificSessionPage(
      {super.key, required this.id, this.activeDepartmentModel, this.onUpdate});
      ...
      listener: (context, state) {
        if (state.postSuccess) {
          BlocProvider.of<ScientificSessionSupervisorCubit>(context)
              .getScientificSessionDetail(id: widget.id);
          CustomAlert.success(
              message: "Success update scientific session", context: context);
        }
                ...
                return SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      if (state.detail?.note != null &&
                          state.detail!.note!.isNotEmpty) ...[
                        const SizedBox(
                          height: 16,
                        ),
                        Container(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    state.detail!.verificationStatus ==
                                            'VERIFIED'
